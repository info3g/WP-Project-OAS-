		...
		<div class="main_wrapper">
			...
			<div class="leftinner">			
				...
				?>
					...
					<div class="type_ad">	
						<h3>Type of Ad</h3>
						<span><input type="checkbox" name="ad_type[]" id="ad_type" class="ad_type sell" data-id="<?php echo $sell;?>" value="selling">Selling Online Ad Space</span>
						<span><input type="checkbox" name="ad_type[]" id="ad_type" class="ad_type buy" data-id="<?php echo $buy;?>"  value="buying">Buying Online Ad Space</span>
					</div>
					...
					<div class="categories">
						...
						<?php 
							...
							foreach ($categories as $category) {
								if($current_cat == $category->slug ){$cond = "checked";}else{$cond = '';}
								$option = '<span><input type="checkbox" name="post_cat[]" '.$cond.' id="cat" class="cat_type ad_type" value="'.$category->term_id.'">'.$category->cat_name.'</span>';
								echo $option;
							}
						?>
					</div>
			...
			<div class="rightinner">	
				...
				<?php 
					...
					if( !empty( $category ) )
					{
						...
						$the_query = $wp_query->query( 'cat='.$category_id.'&post_type=post&posts_per_page=10&paged=' . $paged ); 
							...
							<div class="main">
								<div class="category-posts">
									...
									<div class="inner_right">
										...
										<p><?php echo substr( $the_querys->post_content, 0, 100 );?></p>
									</div>
								</div>
							</div>
						<?php }
				...
				<?php if( $wp_query->max_num_pages > 1 ){ ?>
						<nav>
							<?php previous_posts_link('&laquo; Prev',$wp_query->max_num_pages); ?>
